...
**💰 Atlas Finance** &nbsp; ![live](https://img.shields.io/badge/ao%20vivo-4a9a4a?style=flat-square&labelColor=0a0a0a)
...
**⚔️ Pokédex** &nbsp; ![open source](https://img.shields.io/badge/open%20source-333333?style=flat-square&labelColor=0a0a0a)

Pokédex feita do zero sem IA, consumindo a PokéAPI com vanilla JavaScript.

`HTML` &nbsp; `CSS` &nbsp; `JavaScript` &nbsp; `PokéAPI`

<sub>🔗 [github.com/Theuzinkkj/Pok-dex](https://github.com/Theuzinkkj/Pok-dex)</sub>
